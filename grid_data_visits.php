<?php
	...
	require_once 'class-ta-grid-visits.php';
	$search = array();
	...
	$grid = new TA_Grid_Visits($_GET['key'],$_GET['sdate'], $_GET['edate'], $_GET['period'], $_GET['sidx'], $_GET['sord'], $_GET['page'], $_GET['rows'],$search);
